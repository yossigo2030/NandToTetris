...
"""
        ...
        # self.output_file.write("@SP\nM=M-1\n@SP\nA=M\nD=M\n@ARG\nA=M\nM=D\n")
        # self.output_file.write("@ARG\nD=M+1\n@SP\nM=D\n")
        # self.output_file.write(self.return_helper("1", "THAT") + self.return_helper("2", "THIS") +
        # self.return_helper("3", "ARG") + self.return_helper("4", "LCL"))
        # self.output_file.write("@retAddr" + str(num) + " \nA=M\n0;JMP\n")
        # num += 1

        def return_helper_2(self, segment):
        return "@R11\nD=M-1\nAM=D\nD=M\n@" + segment + "\nM=D\n"
        # def return_helper(self, number, segment) -> str:
        # global num
        # return "@" + number + "\nD=A\n@endFrame" + str(num) + "\nA=M-D\nD=M\n@" + segment + "\nM=D\n"
